...
import com.yibao.mobileapp.activity.AppMainActivity;
...
//                finish();
                break;
            case R.id.tv_register_registered:
            {
                Intent intent= new Intent(RegisterActivity.this, com.yibao.mobileapp.activity.UserRegistered.class);
            ...
            public void requestSeccess(String json) {
                ...
                try {
                    ...
                    if ( object.getBoolean("status") ) {
                        ...
                        setApplicationTokenValue( object.getString("token") );
                        setApplicationApplyPhoneValue(strMobile);
                        Intent intent= new Intent(RegisterActivity.this, AppMainActivity.class);
    ...
    private void setApplicationTokenValue(String v){
        ((MyApplication)this.getApplication()).setToken(v);
    }
    private void setApplicationApplyPhoneValue(String v){
        ((MyApplication)this.getApplication()).setapplyPhone(v);
    }
    ...
    private void findView() {
        ...
        Registered = (TextView) findViewById(R.id.tv_register_registered);
    }
