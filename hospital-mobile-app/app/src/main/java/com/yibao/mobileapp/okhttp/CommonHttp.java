...
import com.livedetect.utils.HttpUtils;
...
//        }
        String token= CommonUtils.getMobile(mContext)+"-"+CommonUtils.getToken(mContext);
...
//        String url="http://222.128.14.106:2989/hospital-dapp/terminal/api/verifyUser";
//        HashMapParams params=new HashMapParams();
//        params.put("image", "");
//        params.put("hospId", "1111");
//        params.put("idNumber","aadsfasd");
//        params.put("treatmentId","aaa111");
//
