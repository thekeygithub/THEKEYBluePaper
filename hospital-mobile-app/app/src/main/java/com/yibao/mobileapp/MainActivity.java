        ...
        setBackDo(new TodoBackFromBeg() {
            ...
            public void backTodo(int requestCode) {
                if (checkPermissions(begRWPermissons, BEGRWCODE)) {
                    ...
                    view1.findViewById(R.id.tv_item_agree).setOnClickListener(MainActivity.this);
                    view1.findViewById(R.id.tv_item_no_agree).setOnClickListener(MainActivity.this);
